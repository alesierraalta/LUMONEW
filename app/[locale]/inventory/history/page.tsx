...
export default function HistoryPage() {
  ...
  useEffect(() => {
    loadAuditLogs()
  }, [searchTerm, operationFilter, tableFilter, dateFilter])
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Sistema completo de seguimiento y trazabilidad
            </p>
          </div>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Busca y filtra el historial de auditoría por diferentes criterios
          </CardDescription>
        </CardHeader>
      ...
      <div className="border-t border-border pt-4 bg-muted rounded-lg px-4 py-3">
