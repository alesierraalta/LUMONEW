...
function EditInventoryItemContent() {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      // Load item data, categories, and locations in parallel
      ...
      if (!itemData) {
        addToast({
          type: 'error',
          title: 'Error',
          description: 'No se pudo encontrar el item solicitado'
        })
      ...
      addToast({
        type: 'error',
        title: 'Error',
        description: 'No se pudieron cargar los datos del item'
      })
      router.push('/inventory')
    } finally {
      setIsLoading(false)
    }
  }, [itemId, addToast, router])
  ...
  const validateForm = (): boolean => {
    ...
    // Min stock validation if provided
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast({
        ...
        description: 'No se pudo actualizar el item de inventario. Por favor intenta de nuevo.'
      })
    } finally {
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6 animate-fade-in">
      <div className="flex items-center justify-between space-y-2">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Editar Item del Inventario</h2>
      ...
      <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
        <CardHeader>
          ...
          <CardDescription>
            Actualiza los campos necesarios para modificar el item del inventario.
          </CardDescription>
        </CardHeader>
        <CardContent>
